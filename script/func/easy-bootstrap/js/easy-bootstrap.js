...
/*=====================================================================================
 * easy-bootstrap-treegrid v1.6.1
 * 
 * @author:zhouzy
 * @date:2013/06/24
    ...
    TreeGrid.prototype = {
        eventListen:function(){
            ...
            this.$gridbody.on('click', "tr[data-rowid]", function(e){that.trclickStyle(e);that.setSelected(e);})
                ...
                .on('click', "tr[data-rowid] td span.shrink,tr[data-rowid] td span.spread", function(e){that.fold(e);})
        ...
        init:function () {
            ...
            this.options.rowNum && (width-=17);
            this.options.checkBox && (width-=23);
            ...
            this.col[this.col.length-1].width -=2;
        ...
        createTreegrid:function(){
            ...
            this.$element.hide();
            this.$treegrid = this.$element.parent();
            this.$treegrid.css("width",width);
            this.$treegrid.css("height",height);

            this.options.title &&
                this.$treegrid.append("<div class=\"title\"><span>" + this.options.title + "</span></div>");
            if(this.options.toolbar){
                this.$treegrid.append("<div class=\"toolbar\"></div>");
                this.createToolbar($(".toolbar",this.$treegrid));
            }
            this.$treegrid.append("<div class=\"grid-view\" style=\"overflow-x:auto\"></div>");
            this.createGrid($(".grid-view",this.$treegrid),height);
        },

        createGrid:function($parent,height){
            var html = "<div class=\"grid-head\" style=\"height:28px;\"></div><div class=\"grid-body\"></div>";
            $parent.append(html);
            var width = 0;
            height -= 28;
            this.options.title && (height-=28);
            this.options.toolbar && (height-=30);
            this.options.rowNum && (width+=17);
            this.options.checkBox && (width+=23);
            $.each(this.col,function(index,data){
                if(data.width){
                    width += data.width + 3;
                }else{
                    width += 100;
        ...
        createHead:function($parent){
            ...
            op.columns && ((function(op){
                $.each(op.columns,function(){
                    ...
                    headHtml.push("<tr>");
                    op.checkBox && headHtml.push("<td style=\"width:20px;\"><div><input type=\"checkbox\"/></div></td>");
                    op.rowNum && headHtml.push("<td style=\"width:14px;\"><div style=\"width:14px;\"></div></td>");
                    $.each(this,function(i){
                        ...
                        $.each(this,function(index,data){
                            if(index == 'filed'){
                                ...
                                thText = "<div class=\"text-overflow\" style=\"width:" + width + "px;\" title=\"" + data + "\" >" + data + "</div>";
                            }
                            else if(index == 'width'){
                                thStyle = thStyle + index + ":" + width + "px;";
                            }
                            else{
        ...
        createBody:function($parent){
            ...
            !function getRowHtml(data,isShow,id){
                $.each(data,function(index,value){
                    ...
                    if (that.specialColor == "1") {
                    	isShow=="show"?
                        html.push("<tr style=\"font-weight:bold;color:#333;\" data-rowid=\"" + id + "\">"):
                        html.push("<tr style=\"font-weight:bold;color:#333;\" data-rowid=\"" + id + "\" style=\"display:none\">");
                    } else if (that.specialColor == "2") {
                    	isShow=="show"?
                        html.push("<tr style=\"font-weight:bold;color:#000;background-color:#ff4444;\" data-rowid=\"" + id + "\">"):
                        html.push("<tr style=\"font-weight:bold;color:#000;background-color:#ff4444;\" data-rowid=\"" + id + "\" style=\"display:none\">");
                    } else {
                    	isShow=="show"?
                    ...
                    op.checkBox && (checkbox = "<td style=\"width:20px;\"><div style=\"width:20px;\"><input type=\"checkbox\"/></div></td>");
                    op.checkBox && this.check && (checkbox = "<td style=\"width:20px;\"><div style=\"width:20px;\"><input type=\"checkbox\" checked/></div></td>");
                    checkbox && html.push(checkbox);

                    op.rowNum && html.push("<td style=\"width:14px;\"><div style=\"width:14px;\">" + rowNum + "</div></td>");
            ...
            function getColHtml(colDef,colData,textIndent,nodeId){
                ...
                $.each(colDef,function(index){
                    ...
                    if(colData.hasChildren){
                    	iconSty = colData.state == "open" ? "spread":"shrink";
                    }
                    if(this.field == "text"){
                        colHtml.push("<td style=\"text-indent:" + textIndent + "px; width:" + width + "px;\">");
                        colHtml.push("<div class=\"text-overflow\" title=\"" + _text + "\" style=\"width:" + width + "px\">");
                        colHtml.push("<span class=\"" + iconSty + "\" data-nodeid=\"" + nodeId + "\"></span>");
                        colHtml.push(text + "</div></td>");
                    }
                    else{
...
/*=====================================================================================
 * easy-bootstrap-datagrid v1.6.1
 * 
 * @author:zhouzy
 * @date:2013/06/28
 * @dependce:jquery
...
!function($){
    ...
    DataGrid.prototype = {
        eventListen:function(){
            ...
            var left = 0;
            var right = 0;
            this.$gridbody.on('click', "tr[data-rowid]", function(e){that.setSelected(e);})
                .on('dblclick', "tr[data-rowid]", function(e){that.onDblClickRow(e);});
            ...
            this.$page && this.$page.on('click',"a[data-page]",function(e){
                ...
                var totalPage = Math.floor(op.total / op.pageSize) + 1;

                if(page == "prevpage"){
                    op.page>1 && (op.page--);
                }
                else if(page == "nextpage"){
                    op.page < totalPage && op.page++;
                }else{
                    page = parseInt(page);
                    op.page = page;
                }
        ...
        createDatagrid:function(){
            ...
            this.$datagrid.css("width",width);
            this.$datagrid.css("height",height);

            this.options.title && this.$datagrid.append("<div class=\"title\"></div>");
            this.$datagrid.append("<div class=\"toolbar\"></div>");
            this.$datagrid.append("<div class=\"grid-view\" style=\"overflow-x:auto\"></div>");
            this.$datagrid.append("<div class=\"page\"></div>");
        ...
        createGrid:function($parent,height){
            ...
            this.options.title && (height-=28);
            this.options.toolbar && (height-=30);
            this.options.pagination && (height-=32);
            this.options.rowNum && (width+=17);
            this.options.checkBox && (width+=23);
            $.each(this.col,function(index,data){
                if(data.width){
        ...
        createBody:function($parent){
            ...
            $.each(op.rows,function(index,value){
                ...
                op.checkBox && bodyHtml.push("<td style=\"width:20px;\"><div style=\"width:20px;\"><input type=\"checkbox\"/></div></td>");
                op.rowNum && bodyHtml.push("<td style=\"width:14px;\"><div style=\"width:14px;\">" + rowNum + "</div></td>");
                $.each(col,function(index,value){
                    ...
                    var _text = ("" + text).replace(/<.\w+\s*[^<]+>/g,"")
                        ,width = col[index].width || 100;
                    bodyHtml.push("<td style=\"width:" + width + "px;\"><div class=\"text-overflow\" title=\""+ _text +"\" style=\"width:" + (width) + "px;\">" + text + "</div></td>");
                });
                bodyHtml.push("</tr>");
                rowNum++;
                id++;
        ...
        createPage:function($parent){
            var page = ""
                ...
                ,totalPage = "1"
                ,totalNum = "0"
                ,cpage = parseInt(this.options.page);
            if(op.pagination){
                op.rows
                    && op.total
                    && (totalNum = op.total)
                    && op.total > 0 && (totalPage = Math.ceil(op.total / op.pageSize));
                page += "共<span class=\"red\">" + totalPage + "</span>页,";
                page += "<span class=\"red\">" + totalNum + "</span>条记录";
                page += "每页<input name=\"pagesize\" type=\"text\" value=\"" + op.pageSize + "\" class=\"pageinput\"/>条记录";
                page += "<a data-page=\"1\"><span class=\"first_btn\">&nbsp;&nbsp;&nbsp;</span></a>";
                page += "<a data-page=\"prevpage\"><span class=\"previous_btn\">&nbsp;&nbsp;&nbsp;</span></a>";
                for(var i=-2; i<3; i++){
                    var shiftpage = i + cpage;
                    if(shiftpage <= totalPage && shiftpage > 0){
                        page += "<a data-page=\"" + shiftpage + "\">" + shiftpage + "</a>";
                    }
                }
                page += "<a data-page=\"nextpage\"><span class=\"next_btn\">&nbsp;&nbsp;&nbsp;</span></a>";
                page += "<a data-page=\""+ totalPage +"\"><span class=\"last_btn\">&nbsp;&nbsp;&nbsp;</span></a>";
                page += "跳转到第<input name=\"pagenum\" type=\"text\" value=\"1\" class=\"pageinput\"/>页 ";
                page += "<input type=\"button\" class=\"renovate\"/>";
                if(this.$page){
                    $parent.html(page);
                }else{
                    $parent.append(page);
    ...
    $.fn.datagrid.defaults = {
        ...
        rowNum:true,
        checkBox:false,
        //每行checkbox被选中时触发回调函数,当该回调函数返回,参数row,rowid
        onChecked:null,
        //使某行checkbox为选中或不选中,参数 rowid, isChecked
        changeRowCheck:null,
        pagination:true,
        pageSize:10,
        page:1,
    ...
    $(window).on('load', function(){
        $("table[class='datagrid']").each(function () {
            var $tgrid = $(this)
                , data = $tgrid.data('options');
            if(!data) return;
            $tgrid.datagrid((new Function("return {" + data + "}"))());
        });
    });
}(window.jQuery);
